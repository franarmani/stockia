        ...
        <div className="flex-1 lg:flex lg:items-center lg:justify-center lg:px-12 lg:py-10">
          <div className="w-full lg:max-w-sm bg-[#0d1b2d] lg:bg-transparent rounded-t-[28px] lg:rounded-none px-6 lg:px-0 pt-8 lg:pt-0 pb-12 lg:pb-0">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div>
                <label className="block text-[13px] font-medium text-slate-300 lg:text-white/70 mb-1.5">Tu nombre</label>
                <div className="relative">
                  <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 lg:text-white/35" />
                  <input type="text" value={form.fullName} onChange={(e) => setForm({ ...form, fullName: e.target.value })}
                    placeholder="Juan Pérez" autoComplete="name" className={inputCls} />
                </div>
              </div>
              <div>
                <label className="block text-[13px] font-medium text-slate-300 lg:text-white/70 mb-1.5">Nombre del negocio</label>
                <div className="relative">
                  <Store className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 lg:text-white/35" />
              ...
              <div>
                <label className="block text-[13px] font-medium text-slate-300 lg:text-white/70 mb-1.5">Contraseña</label>
                <div className="relative">
            ...
            <p className="text-center text-[13px] text-slate-400 lg:text-white/40 mt-6">
              ¿Ya tenés cuenta?{' '}
              <Link to="/login" className="text-primary lg:text-primary/80 font-semibold hover:underline">
                Iniciar sesión
              </Link>
            </p>
          </div>
