      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 space-y-6">
        ...
        <div className="glass-card p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border border-green-500/20 bg-green-500/5">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-white/40 font-medium">Sugerido: $70.000 / mes · Plan Negocio</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <button
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="glass-card p-5 flex flex-col gap-3 relative overflow-hidden group hover:border-white/10 transition-all">
                      ...
                      <tr key={b.id} className={`border-b border-white/5 last:border-0 ${i % 2 === 0 ? '' : 'bg-white/1'}`}>
                        ...
                        <td className="px-4 py-3">
                          {canManagePlans ? (
                            ...
                            >
                              <option value="free" className="bg-slate-900">Inicial</option>
                              <option value="vip" className="bg-slate-900">Negocio</option>
                            </select>
                          ) : (
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center justify-end gap-1.5">
                            ...
                            <button
                              ...
                              className="w-8 h-8 rounded-lg bg-blue-500/15 hover:bg-blue-500/40 flex items-center justify-center text-blue-400 transition-colors"
                              title="Sumar 30 días"
                            >
