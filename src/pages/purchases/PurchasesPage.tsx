        ...
        <div className="bg-white/6 border border-white/10 rounded-2xl p-5 space-y-4 animate-fade-in-up">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-2">
              ...
              >
                <option value="" className="bg-[#07111f]">Sin proveedor</option>
                {suppliers.map(s => (
                  <option key={s.id} value={s.id} className="bg-[#07111f]">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              {showProductPicker && filteredProducts.length > 0 && (
                <div className="absolute top-11 left-0 right-0 bg-[rgba(7,17,31,0.98)] border border-white/12 rounded-2xl shadow-2xl z-20 max-h-56 overflow-auto backdrop-blur-xl">
