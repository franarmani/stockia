    ...
    <div className="animate-fade-in space-y-6 max-w-5xl mx-auto pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-[#0d1b2d] border border-white/10 rounded-xl p-6 md:p-8 relative overflow-hidden">
          ...
          {analysis && (
            <div className="animate-fade-in space-y-4">
              <div className="bg-[#0d1b2d] border border-white/10 rounded-xl p-6 border-green-500/20 bg-green-500/5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-[#0d1b2d] border border-white/10 rounded-xl p-6 border-red-500/20 bg-red-500/5">
                ...
                <div className="bg-[#0d1b2d] border border-white/10 rounded-xl p-6 border-blue-500/20 bg-blue-500/5">
              ...
              <div className="bg-[#0d1b2d] border border-white/10 rounded-xl p-6 border-primary/20 bg-primary/5">
              ...
              <div className="bg-[#0d1b2d] border border-white/10 rounded-xl p-6 bg-primary/5">
          ...
          {/* Quick Stats Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-[#0d1b2d] border border-white/10 rounded-xl p-5 flex items-center gap-4">
        ...
        <div className="space-y-6">
          <div className="bg-[#0d1b2d] border border-white/10 rounded-xl border-primary/30 bg-primary/5 p-6 relative overflow-hidden group">
             ...
             <div className="relative z-10">
               ...
               <div className="mb-6 p-3 rounded-xl bg-primary/10 border border-primary/20 flex gap-3 items-start group/promo hover:bg-primary/15 transition-colors">
                 ...
                 <div>
                   ...
                   <p className="text-[10px] text-white/50 leading-tight mt-0.5">
                      Este modo está incluido en tu <span className="text-primary font-bold">Plan Negocio ($70.000/mes)</span>.
                   </p>
                 </div>
               </div>
               ...
               <Button 
                ...
                disabled={analyzing}
                className="w-full h-11 bg-primary text-white font-bold hover:bg-primary/90 shadow-lg shadow-primary/20"
               >
                 {analyzing ? (
                   <>
          ...
          <div className="bg-[#0d1b2d] border border-white/10 rounded-xl p-6">
