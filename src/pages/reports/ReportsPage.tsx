  ...
  return (
    <div className="animate-fade-in flex flex-col gap-6 max-w-6xl mx-auto w-full pb-12">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 p-1">
        <div className="bg-orange-500 rounded-[2rem] p-6 text-white relative overflow-hidden group shadow-xl shadow-orange-500/20 col-span-2 lg:col-span-1">
              ...
              {topProducts.map((p, i) => (
                <div key={i} className="flex items-center gap-4 px-6 py-4 hover:bg-white/[0.02] transition-all group">
                  <div className={cn(
                    ...
                    i === 0 ? "bg-orange-500 text-white shadow-lg shadow-orange-500/20" : "bg-white/5 text-white/40"
                  )}>
                    {i + 1}
                  </div>
          ...
          {sellerBreakdown.length === 0 ? (
            ...
            <div className="divide-y divide-white/[0.02] mt-4">
              {sellerBreakdown.map((s, i) => (
                <div key={i} className="flex items-center gap-4 px-6 py-4 hover:bg-white/[0.02] transition-all group">
                  <div className="w-10 h-10 rounded-2xl bg-emerald-500/10 border border-emerald-500/10 flex items-center justify-center shrink-0 group-hover:bg-emerald-500 group-hover:text-white transition-all">
