...
export default function DailySummaryModal({ onClose, date }: DailySummaryModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-[#0d1b2d] border border-white/10 w-full max-w-md rounded-2xl overflow-hidden animate-fade-in">
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/10 bg-primary/10">
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2 pt-1">
                <button
                  ...
                  className="flex-1 bg-white/5 border border-white/10 text-slate-300 hover:bg-white/5 flex items-center justify-center gap-1.5 text-[12px] py-2.5 rounded-xl"
                >
