...
export default function NotificationsPage() {
  ...
  const { notifications, loading, fetch, markRead, markAllRead, generate, startPolling, stopPolling } = useNotificationsStore()
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-2">
          {unread > 0 && (
            <button
              ...
              className="bg-white/5 border border-white/10 text-slate-300 hover:bg-white/5 flex items-center gap-1.5 text-[12px]"
            >
          ...
          <button
            ...
            className="bg-white/5 border border-white/10 text-slate-300 hover:bg-white/5 text-[12px]"
          >
            Actualizar
          </button>
        </div>
      ...
      {/* List */}
      <div className="bg-[#0d1b2d] border border-white/10 rounded-xl divide-y divide-white/5 rounded-2xl overflow-hidden">
        {loading ? (
