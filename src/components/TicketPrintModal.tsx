        ...
        <div className="flex gap-2">
          <button onClick={() => setSelectedWidth('58mm')}
            className={`flex-1 py-2 text-sm rounded-lg border-2 font-medium transition ${
              selectedWidth === '58mm' ? 'border-primary bg-primary/5 text-primary' : 'border-white/10 text-muted-foreground'
            }`}>58mm</button>
          <button onClick={() => setSelectedWidth('80mm')}
            className={`flex-1 py-2 text-sm rounded-lg border-2 font-medium transition ${
              selectedWidth === '80mm' ? 'border-primary bg-primary/5 text-primary' : 'border-white/10 text-muted-foreground'
            }`}>80mm</button>
        </div>
