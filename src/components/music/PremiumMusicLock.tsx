  ...
  return (
    <div className="relative flex-1 flex flex-col items-center justify-center min-h-[80vh] p-6 text-center overflow-hidden">
      ...
      <div className="relative mb-10 select-none">
        <div className="w-28 h-28 rounded-[2rem] bg-primary/10 flex items-center justify-center border border-white/10 relative group transition-transform duration-500 hover:scale-105">
           <Music className="w-12 h-12 text-primary" />
           <div className="absolute -top-4 -right-4 w-12 h-12 rounded-2xl bg-primary flex items-center justify-center border border-white/20 animate-bounce-slow">
      ...
      <div className="max-w-2xl space-y-6 relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight leading-tight">
          ...
          tu negocio con <span className="text-primary">Stockia Music</span>
        </h1>
