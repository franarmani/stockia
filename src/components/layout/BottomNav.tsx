      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-surface-elevated border-t border-white/10 safe-bottom">
        <div className="flex items-stretch h-16">
          ...
          <button
            ...
            className="flex-1 flex flex-col items-center justify-center gap-1 text-[10px] font-medium text-slate-400 active:text-slate-400"
          >
            ...
            <div className="grid grid-cols-3 gap-3 p-5">
              {MORE_NAV.map((item) => (
                <button
                  ...
                  className="flex flex-col items-center gap-2 p-3 rounded-2xl bg-white/5 hover:bg-white/10 active:bg-white/15 transition-colors"
                >
