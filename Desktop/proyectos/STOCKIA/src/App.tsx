...
// When a new deploy changes chunk hashes, users with cached HTML get 404s on old chunks.
// This detects that and forces a single reload to pick up the new HTML.
...
const WhatsappPanel = lazy(() => import('@/pages/whatsapp/WhatsappPanel'))
