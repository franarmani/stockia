...
import {
  ...
  Calendar, Download, RotateCcw, Loader2, MessageCircle,
} from 'lucide-react'
                ...
                <TableRow key={inv.id} className={inv.voided ? 'opacity-50' : ''}>
                  ...
                  <TableCell>
                    <div className="flex gap-1">
                      ...
                      <button onClick={() => navigate(`/whatsapp?context=invoice&contextId=${inv.id}&customerId=${inv.customer_id || ''}`)} className="w-7 h-7 rounded-xl flex items-center justify-center text-muted-foreground hover:text-[#25D366] hover:bg-emerald-50 transition" title="Enviar por WhatsApp">
